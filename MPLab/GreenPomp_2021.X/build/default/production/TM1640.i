...
# 53 "C:/Program Files/Microchip/MPLABX/v5.45/packs/Microchip/PIC16F1xxxx_DFP/1.5.133/xc8\pic\include\proc\pic16f18323.h"
...
extern volatile __bit AS2E __at(0x34C2);
...
_delay((unsigned long)((350)*(1000000/4000000.0)));
do { LATCbits.LATC1 = 1; } while(0);
data >>=1;
_delay((unsigned long)((500)*(1000000/4000000.0)));
}
...
digit_low = value % 10;
digit_high = value / 10;
if (digit_high==0) digit_high=10;
TM1640_sendCommand(0b01000100);
TM1640_sendAddress_and_Data( 0b11000001, NUMBER_FONT[digit_low]);
TM1640_sendCommand(0b01000100);
TM1640_sendAddress_and_Data( 0b11000000, NUMBER_FONT[digit_high]);
TM1640_sendCommand(0b10001111);
TM1640_sendCommand(0b10001111);
}
...
TM1640_sendCommand(0b01000100);
if (dot) {
TM1640_sendAddress_and_Data( 0b11000000, NUMBER_FONT[digit_high]|DOT);
} else if (digit_high != 0) {
TM1640_sendAddress_and_Data( 0b11000000, NUMBER_FONT[digit_high]);
} else {
TM1640_sendAddress_and_Data( 0b11000000, NUMBER_FONT[10]);
}
TM1640_sendCommand(0b10001111);
TM1640_sendCommand(0b10001111);
}
...
voltage = (unsigned int)(50U * value / 1024U) ;
...
TM1640_sendCommand(0b10001111);
TM1640_sendCommand(0b01000100);
TM1640_sendAddress_and_Data( 0b11000000, data);
}

void TM1640_dispLowBat(){
TM1640_sendCommand(0b01000100);
TM1640_sendAddress_and_Data( 0b11000001, LO_BAT[1]);
TM1640_sendAddress_and_Data( 0b11000000, LO_BAT[0]);
TM1640_sendCommand(0b10001111);
}
...
TM1640_sendCommand(0b01000100);
TM1640_sendAddress_and_Data( 0b11000001, digit );
TM1640_sendAddress_and_Data( 0b11000000, digit );
TM1640_sendCommand(0b10000000);
}
...
TM1640_sendCommand(0b01000100);
TM1640_sendAddress_and_Data( 0b11000010, pattern);
TM1640_sendCommand(0b10001000);
TM1640_sendCommand(0b10001111);
}
